...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28-Out-2024 às 17:44
...
(3, '12835639080', 'Aprendizagem Industrial', 'Saída Antecipada', '2024-10-25', 'Alunos/12835639080/atestado_2024-10-25.pdf', '');
...
(4, '05357296006', 'Aprendizagem Industrial', 'Histórico Parcial', 'Histórico para apresentar para vaga de emprego', 'Concluído', 'Envios/05357296006/arquivo_enviado.pdf', 'A Retirada do Documento é feita na Instituição. Você Receberá um comunicado via e-mail ou WhatsApp'),
(5, '05357296006', 'Curso Técnico', 'Recuperação', '', 'Concluído', 'Envios/05357296006/arquivo_enviado.pdf', 'A Retirada do Documento é feita na Instituição. Você Receberá um comunicado via e-mail ou WhatsApp'),
(6, '12835639080', 'Qualificação Profissional', 'Declaração de Transferência', '', 'Em Andamento', '', '');
